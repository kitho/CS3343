...
//		flights.add(flight3);
//		
//		AirlineCompany airlineCompany1 = new AirlineCompany("Cathay Pacific Airways");
//		airlineCompany1.addFlight(flight1);
//		AirlineCompany airlineCompany2 = new AirlineCompany("China Airlines");
//		airlineCompany2.addFlight(flight2);
//		AirlineCompany airlineCompany3 = new AirlineCompany("Hong Kong Airlines");
//		airlineCompany3.addFlight(flight3);
//		
//		List<AirlineCompany> airlineCompanies= new ArrayList<AirlineCompany>();
